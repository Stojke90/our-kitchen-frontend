...
const AllRecipes = (props) => {
  ...
  // is user recipes empthy array or not
        ...
        <Box sx={{ p: 2 }}>
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={gridCon}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={conForCards}>
              {userRecipes.length === 0 && !haveRecipes && <SkeletonLoader />}

              {userRecipes.length === 0 && haveRecipes && (
                <Typography sx={noRecipes}>
                  No recipes made, please create recipes...
                </Typography>
              )}
